...
SECRET_KEY = 'django-insecure-b1ssmzw9mqs$x_67aslmqmbdha#ib7-0x#fu&510x*p&udg8zb'
...
# Ensure a secure secret key for production
SECRET_KEY = os.getenv('SECRET_KEY', 'unsafe-development-key')

# Restrict allowed hosts
ALLOWED_HOSTS = ['yourdomain.com', 'www.yourdomain.com']

# Content Security Policy (CSP) Header (requires django-csp or manual middleware)
...
# Security settings
SECURE_SSL_REDIRECT = True
SECURE_PROXY_SSL_HEADER = ('HTTP_X_FORWARDED_PROTO', 'https')  # Trust the 'X-Forwarded-Proto' header for HTTPS
